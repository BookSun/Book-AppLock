 ...
 */
public class bookChooseLockPattern extends PreferenceActivity {
    ...
    public Intent getIntent() {
        ...
        modIntent.putExtra(EXTRA_SHOW_FRAGMENT,
                bookChooseLockPatternFragment.class.getName());
        modIntent.putExtra(EXTRA_NO_HEADERS, true);
        return modIntent;
    }
    protected boolean isValidFragment(String fragmentName) {
        if (bookChooseLockPatternFragment.class.getName().equals(fragmentName))
            return true;
        return false;
    }
    @Override
    ...
    public static class bookChooseLockPatternFragment extends Fragment implements
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mModifyString = intent.getStringExtra("com.book.app.lock.MODIFY_PASSWORD");
        }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            mLockPatternView
                    .setTactileFeedbackEnabled(true);//mChooseLockSettingsHelper
        ...
        private void saveChosenPatternAndFinish() {
            ...
            utils.savebookAppLockPattern(mChosenPattern);
            if (mModifyString == null) {
                Intent intent = new Intent();
                intent.setClassName("com.book.app.lock",
                      "com.book.app.lock.bookAppLockActivity");
